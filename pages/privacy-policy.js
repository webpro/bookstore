...
export default () => (
  <Fragment>
    <Head>
      <title>Bookstore Privacy Policy</title>
    </Head>
    <Header title="Privacy Policy" />

    <p>Effective date: November 29, 2018</p>

    <p>Bookstore ("us", "we", or "our") operates the https://bookstore-webpro.now.sh website (the "Service").</p>
    ...
    <p>Bookstore uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>
      Bookstore will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
    ...
    <p>Bookstore may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
      <li>To comply with a legal obligation</li>
      <li>To protect and defend the rights or property of Bookstore</li>
